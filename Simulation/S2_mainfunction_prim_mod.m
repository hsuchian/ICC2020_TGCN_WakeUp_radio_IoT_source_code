...
function [SuccessProb_prim_mod, TransmissionTime_prim_mod, EnergyConsumption_prim_mod, Times_waked_prim_mod, partition_result_prim_mod, middle_point_prim_mod ] = S2_mainfunction_prim_mod(max_range, num_devices, UAVradius, fscale, pointX, pointY, Length_of_hash)
   ...
   hash_inner(3,:) = hash2;
    ...
    [partition_result_prim_mod, num_subgroups_our, middle_point_prim_mod] = S2_partition_prim_mod(pointX, pointY, UAVradius);
