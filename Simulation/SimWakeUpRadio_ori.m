...
function  [Success_table, TransmissionTime, EnergyConsumption] = SimWakeUpRadio_ori(numSensor, FrameL, RFrameM)
    ...
    for i = 1:numSensor
        ...
        end                                  % after successed                                           calculating 
    end
    
    
    % !!!!!!!!!!!!!!!!!!!!!!! cause problem if RFrameM = 0 !!!!!!!!!!!!!!!!!!!!!!! since no implementation 
