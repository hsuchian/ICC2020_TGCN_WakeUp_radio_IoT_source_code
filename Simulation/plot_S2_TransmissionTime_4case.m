...
plot( scaleArray*num_devices , Transmission_Time_prim_mod(1,:), 'r-*');
%plot( scaleArray*num_devices , Transmission_Time_prim(1,:), 'r:*');
plot( scaleArray*num_devices , Transmission_Time_prim_final(1,:), 'r-.*');
plot( scaleArray*num_devices , Transmission_Time_convex(1,:), 'r--*');

plot( scaleArray*num_devices , Transmission_Time_prim_mod(2,:), 'g-s');
%plot( scaleArray*num_devices , Transmission_Time_prim(2,:), 'g:s');
plot( scaleArray*num_devices , Transmission_Time_prim_final(2,:), 'g-.s');
plot( scaleArray*num_devices , Transmission_Time_convex(2,:), 'g--s');

plot( scaleArray*num_devices , Transmission_Time_prim_mod(3,:), 'b-d');
%plot( scaleArray*num_devices , Transmission_Time_prim(3,:), 'b:d');
plot( scaleArray*num_devices , Transmission_Time_prim_final(3,:), 'b-.d');
plot( scaleArray*num_devices , Transmission_Time_convex(3,:), 'b--d');
...
print(f1, '-depsc', ['picture\','S2_4case_AccessDelay_Sim_', num2str(Sim_time_ppp),'_N_', num2str(num_devices_ppp),  '.eps']);