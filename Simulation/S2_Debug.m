...
num_devices = 50;
max_range = 100;       % length width in meter
UAVradius = 20;        % meter
...
tic 
            ...
            x5 = width*(0.6*rand()+2.933);
            y5 = 0.7*width*(rand());
            
            x6 =  0.8*width*(0.6*rand()+2.933);
            y6 = 0.9*width*(rand()+2);
            ...
            y7 = width*(0.6*rand()+2.933);
             ...
             % ------------------------------------------   up
            x8 = width*(rand()+2);
            y8 = 0.8*width*(2.4*rand()+1.133);
            
            x9 = width*(rand()+1);
            y9 = width*(0.5*rand()+3.033);
            
            x10 = width*(rand()+1);
            y10 = 0.9*width*(1.6*rand()+1.4);
            
             % ------------------------------------------   left
            x11 = 0.7*width*(rand());
            y11 = width*(0.7*rand()+2.833);
            
            x12 = width*(0.3*rand()+0.7);
            y12 = width*(rand()+1);
            
            x_gen = [x1;x2;x3;x4;x5;x6;x7;x8;x9;x10;x11;x12];
            y_gen = [y1;y2;y3;y4;y5;y6;y7;y8;y9;y10;y11;y12];
            ...
            % S2_mainfunction(max_range, num_devices, UAVradius, fscale, pointX, pointY)
             ...
             S2_mainfunction(max_range, round(num_devices*scale), UAVradius, fscale, pointX, pointY, 200, Length_of_hash);
            [SuccessProb_sq, TransmissionTime_sq, EnergyConsumption_sq, Times_waked_sq, partition_sq, m_point_sq ] = ...
            S2_mainfunction_sq(max_range, round(num_devices*scale), UAVradius, fscale, pointX, pointY, 200, Length_of_hash);
            
        %fscale = scaleArray_frame_length(2);
        %[SuccessProb1, TransmissionTime1, EnergyConsumption1] = ...
        %     S2_mainfunction(max_range, round(num_devices*scale), UAVradius, fscale, pointX, pointY, 200, Length_of_hash);
        %    [SuccessProb_sq1, TransmissionTime_sq1, EnergyConsumption_sq1] = ...
        %    S2_mainfunction_sq(max_range, round(num_devices*scale), UAVradius, fscale, pointX, pointY, 200, Length_of_hash);
        
        %fscale = scaleArray_frame_length(3);
        %[SuccessProb2, TransmissionTime2, EnergyConsumption2] = ...
        %     S2_mainfunction(max_range, round(num_devices*scale), UAVradius, fscale, pointX, pointY, 200, Length_of_hash);
        %    [SuccessProb_sq2, TransmissionTime_sq2, EnergyConsumption_sq2] = ...
        %    S2_mainfunction_sq(max_range, round(num_devices*scale), UAVradius, fscale, pointX, pointY, 200, Length_of_hash);
