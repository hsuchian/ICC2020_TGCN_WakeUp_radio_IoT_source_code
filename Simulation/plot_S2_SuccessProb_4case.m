...
plot( scaleArray*num_devices , Success_Prob_prim_mod(1,:), 'r-*');
%plot( scaleArray*num_devices , Success_Prob_prim(1,:), 'r:*');
plot( scaleArray*num_devices , Success_Prob_prim_final(1,:), 'r-.*');
plot( scaleArray*num_devices , Success_Prob_convex(1,:), 'r--*');

plot( scaleArray*num_devices , Success_Prob_prim_mod(2,:), 'g-s');
%plot( scaleArray*num_devices , Success_Prob_prim(2,:), 'g:s');
plot( scaleArray*num_devices , Success_Prob_prim_final(2,:), 'g-.s');
plot( scaleArray*num_devices , Success_Prob_convex(2,:), 'g--s');

plot( scaleArray*num_devices , Success_Prob_prim_mod(3,:), 'b-d');
%plot( scaleArray*num_devices , Success_Prob_prim(3,:), 'b:d');
plot( scaleArray*num_devices , Success_Prob_prim_final(3,:), 'b-.d');
plot( scaleArray*num_devices , Success_Prob_convex(3,:), 'b--d');
...
print(f1, '-depsc', ['picture\','S2_4case_SuccessProb_Sim_', num2str(Sim_time_ppp),'_N_', num2str(num_devices_ppp),  '.eps']);
